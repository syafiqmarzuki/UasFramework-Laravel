                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="sportsmagazine-player-thumb-wrap">
                                <figure><img src="{{asset('assetfront/extra-images/player-text-img.png')}}" alt=""></figure>
                                <div class="sportsmagazine-player-thumb-text">
                                    <h2>10</h2>
                                    <h3>Darren <br><span> Stayen</span></h3>
				...
				<div class="container">
					<div class="row">
                        ...
                        <div class="col-md-9">
                                ...
                                <ul>
                                    <li>
                                        <div class="sportsmagazine-prev-post">
                                            <figure><a href="404.html"><img src="{{asset('assetfront/extra-images/post-img1.jpg')}}" alt=""></a></figure>
                                    ...
                                    <li>
                                        <div class="sportsmagazine-next-post">
                                            <figure><a href="404.html"><img src="{{asset('assetfront/extra-images/post-img2.jpg')}}" alt=""></a></figure>
                            ...
                            <div class="sportsmagazine-section-heading"><h2>Related Players</h2></div>
                            <div class="sportsmagazine-player sportsmagazine-player-grid">
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure><a href="player-detail.html"><img src="{{asset('assetfront/extra-images/player-grid-img1.jpg')}}" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">Darren Layfield</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="player-detail.html"><img src="{{asset('assetfront/extra-images/player-grid-img2.jpg')}}" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                            <h5><a href="player-detail.html">Marlon Samuals</a></h5>
                                            <p>Lorem ipsum dolor sit met, con etur adipiscing elit. Ut c males ante curabitur.</p>
                                        </div>
                                        <ul class="sportsmagazine-player-grid-social">
                                            <li><a href="https://www.facebook.com/" class="sportsmagazine-colorhover fa fa-facebook-official"></a></li>
                                    ...
                                    <li class="col-md-4">
                                        <figure><a href="player-detail.html"><img src="{{asset('assetfront/extra-images/player-grid-img9.jpg')}}" alt=""><i class="fa fa-link"></i></a><span></span></figure>
                                        <div class="sportsmagazine-player-grid-text">
                                            <a href="player-detail.html" class="forward-btn">Forword</a>
                                ...
                                <ul>
                                    <li>
                                        <div class="sportsmagazine-popular-post">
                                            <figure><a href="blog-detail.html"><img src="{{asset('assetfront/extra-images/widget-popular-post1.jpg')}}" alt=""></a></figure>
                                    ...
                                    <li>
                                        <div class="sportsmagazine-popular-post">
                                            <figure><a href="blog-detail.html"><img src="{{asset('assetfront/extra-images/widget-popular-post2.jpg')}}" alt=""></a></figure>
                                            <div class="sportsmagazine-popular-post-text">
                                                <h5><a href="blog-detail.html">Mark Johnson has as acture and is gona</a></h5>
                                                <time datetime="2008-02-14 20:00">August 23rd, 2016</time>
                                            </div>
                                    ...
                                    <li>
                                        <div class="sportsmagazine-popular-post">
                                            <figure><a href="blog-detail.html"><img src="{{asset('assetfront/extra-images/widget-popular-post3.jpg')}}" alt=""></a></figure>
                                            <div class="sportsmagazine-popular-post-text">
                                                <h5><a href="blog-detail.html">Mark Johnson has as acture and is gona</a></h5>
                                                <time datetime="2008-02-14 20:00">August 23rd, 2016</time>
                                            </div>
                                    ...
                                    <li>
                                        <div class="sportsmagazine-popular-post">
                                            <figure><a href="blog-detail.html"><img src="{{asset('assetfront/extra-images/widget-popular-post4.jpg')}}" alt=""></a></figure>
                                            <div class="sportsmagazine-popular-post-text">
                                                <h5><a href="blog-detail.html">Mark Johnson has as acture and is gona</a></h5>
                                                <time datetime="2008-02-14 20:00">August 23rd, 2016</time>
                                            </div>
